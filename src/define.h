...
#include "vbuf.h"
    ...
    #include <errno.h>
#endif
/* The iconv.h file was added from internet. Please see header in iconv.h */
#ifdef HAVE_ICONV
	#ifdef _MSC_VER
		#include "iconv.h"
	 #else
	...
	#endif
#endif
//pcre has a POSIX wrapper for the regex
// make sure you download and reference library
// before defining 
#ifdef HAVE_REGEX_H
    #include <regex.h>
#endif
...
#else
//added to compensate for deprecated warnings in Windows compiler
#define _strdup strdup
#endif
//added for conflict with the crt definitions
	...
	#endif
		//PATH_MAX is not defined for windows but MAX_PATH is
#ifdef _MSC_VER
